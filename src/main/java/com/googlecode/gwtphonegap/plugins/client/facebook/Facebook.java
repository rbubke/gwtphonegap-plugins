package com.googlecode.gwtphonegap.plugins.client.facebook;
...
public interface Facebook extends PhoneGapPlugin {
	 ...
	 */
	<T extends JavaScriptObject> void api(String path, Map<String, String> options, GenericCallback<T> callback);
	 ...
	 * @param callback
	 */
	<T extends JavaScriptObject> void ui(String method, Map<String, String> options, GenericCallback<T> callback);
