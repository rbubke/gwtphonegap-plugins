 ...
 * the License.
 */
package com.googlecode.gwtphonegap.plugins.client.facebook.impl;
...
import com.googlecode.gwtphonegap.plugins.client.facebook.Facebook;
import com.googlecode.gwtphonegap.plugins.client.facebook.callback.GenericCallback;
import com.googlecode.gwtphonegap.plugins.client.facebook.callback.LoginStatusCallback;
import com.googlecode.gwtphonegap.plugins.client.facebook.event.AuthEvent;
import com.googlecode.gwtphonegap.plugins.client.facebook.event.AuthHandler;
import com.googlecode.gwtphonegap.plugins.client.facebook.jsni.LoginStatus;
import com.googlecode.gwtphonegap.plugins.client.util.JSNIHelper;
...
public class FacebookJsImpl implements Facebook {
	...
	public void fireAuthLoginEvent(LoginStatus loginStatus) {
		handlerManager.fireEvent(new AuthEvent(AuthEvent.AuthEventType.LOGIN, loginStatus));
	}

	public void fireAuthLogoutEvent(LoginStatus loginStatus) {
		handlerManager.fireEvent(new AuthEvent(AuthEvent.AuthEventType.LOGOUT, loginStatus));
	}

	public void fireAuthResponseChangeEvent(LoginStatus loginStatus) {
		handlerManager.fireEvent(new AuthEvent(AuthEvent.AuthEventType.RESPONSE_CHANGE, loginStatus));
	}

	public void fireAuthStatusChangeEvent(LoginStatus loginStatus) {
		handlerManager.fireEvent(new AuthEvent(AuthEvent.AuthEventType.STATUS_CHANGE, loginStatus));
	}
	...
	private void ensurePluginInstalled() {
		if (!isPluginInstalled()) {
			throw new IllegalStateException("Can't find Facebook plugin - did you include neccessary javascript files?");
		}
	}
	...
	/*-{
        $wnd.FB.getLoginStatus(
            function (response) {
                if (callback)
                    callback.@com.googlecode.gwtphonegap.plugins.client.facebook.callback.LoginStatusCallback::onResponse(Lcom/googlecode/gwtphonegap/plugins/client/facebook/jsni/LoginStatus;)(response);
            }, force);
    }-*/;
	...
	private native void loginNative(JavaScriptObject options, LoginStatusCallback callback)
	/*-{
        $wnd.FB.login(
            function (response) {
                if (callback) {
	...
	private native <T extends JavaScriptObject> void apiNative(String path, JavaScriptObject options, GenericCallback<T> callback)
	/*-{
        $wnd.FB.api(
            path,
            options,
            function (result) {
                if (callback) {
                    if (result.error)
                        callback.@com.googlecode.gwtphonegap.plugins.client.facebook.callback.GenericCallback::onError(Lcom/googlecode/gwtphonegap/plugins/client/facebook/jsni/ErrorResponse;)(result.error);
                    else {
                        callback.@com.googlecode.gwtphonegap.plugins.client.facebook.callback.GenericCallback::onResponse(Lcom/google/gwt/core/client/JavaScriptObject;)(result);
                    }
                }
            });
    }-*/;

	private native <T extends JavaScriptObject> void uiNative(JavaScriptObject options, GenericCallback<T> callback)
	/*-{
        $wnd.FB.ui(
            options,
            function (result) {
	...
	/*-{
        ...
        $wnd.FB.Event.subscribe('auth.login',
            function (response) {
                that.@com.googlecode.gwtphonegap.plugins.client.facebook.impl.FacebookJsImpl::fireAuthLoginEvent(Lcom/googlecode/gwtphonegap/plugins/client/facebook/jsni/LoginStatus;)(response);
            });
        $wnd.FB.Event.subscribe('auth.logout',
            function (response) {
                that.@com.googlecode.gwtphonegap.plugins.client.facebook.impl.FacebookJsImpl::fireAuthLogoutEvent(Lcom/googlecode/gwtphonegap/plugins/client/facebook/jsni/LoginStatus;)(response);
            });
        $wnd.FB.Event.subscribe('auth.sessionChange',
            function (response) {
                that.@com.googlecode.gwtphonegap.plugins.client.facebook.impl.FacebookJsImpl::fireAuthResponseChangeEvent(Lcom/googlecode/gwtphonegap/plugins/client/facebook/jsni/LoginStatus;)(response);
            });
        $wnd.FB.Event.subscribe('auth.statusChange',
            function (response) {
                that.@com.googlecode.gwtphonegap.plugins.client.facebook.impl.FacebookJsImpl::fireAuthStatusChangeEvent(Lcom/googlecode/gwtphonegap/plugins/client/facebook/jsni/LoginStatus;)(response);
            });
    }-*/;
}
