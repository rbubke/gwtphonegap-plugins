 ...
 * the License.
 */
package com.googlecode.gwtphonegap.plugins.client.facebook.event;
...
public class AuthEvent extends GwtEvent<AuthHandler> {
	...
	private static final Type<AuthHandler> TYPE = new Type<AuthHandler>();
	...
	public static Type<AuthHandler> getType() {
		return TYPE;
	}
